...
class iplayScreen extends StatefulWidget {
  iplayScreen({Key? key}) : super(key: key);

  @override
  _iplayScreenState createState() => _iplayScreenState();
}

class _iplayScreenState extends State<iplayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('iplay Details',style: TextStyle(color: AppStyle.appBarColor)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('Charges: 4000',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ...
                    SizedBox(height: 20),
                    Container(
                      child:  Text('GST @18%: 720',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    Divider(
                      thickness: 5,
                    ),
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Total: 4720',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    // Divider(),
                    // SizedBox(height: 20),
                    // Container(
                    ...
                    Container(
                      alignment: Alignment.center,
                      padding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child:  Text('Capacity: 30',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                    ),
                    ...
                    Container(
                      alignment: Alignment.center,
                      padding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child:  Text('Avalibality: Only till 7:30 PM',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                    ),
                    SizedBox(height: 20),
