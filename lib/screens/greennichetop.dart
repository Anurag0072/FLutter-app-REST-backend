...
class gntScreen extends StatefulWidget {
  gntScreen({Key? key}) : super(key: key);

  @override
  _gntScreenState createState() => _gntScreenState();
}

class _gntScreenState extends State<gntScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Green Niche Top Details',style: TextStyle(color: AppStyle.appBarColor)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      alignment: Alignment.center,
                      padding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child:  Text('Capacity: 38',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                    ),
