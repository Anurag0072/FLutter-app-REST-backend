...
class cascadeScreen extends StatefulWidget {
  cascadeScreen({Key? key}) : super(key: key);

  @override
  _cascadeScreenState createState() => _cascadeScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Cascade Details',style: TextStyle(color: AppStyle.appBarColor)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      alignment: Alignment.center,
                      padding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child:  Text('Capacity: 45',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                    ),
