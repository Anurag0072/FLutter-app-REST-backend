...
class gymScreen extends StatefulWidget {
  gymScreen({Key? key}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('Monday to Saturday: 6.30AM - 2PM ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ...
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Break: 2PM - 3PM',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    Divider(
                      thickness: 5,
                    ),
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Monday to Saturday: 3PM - 10PM',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    // Divider(),
                    // SizedBox(height: 20),
                    // Container(
