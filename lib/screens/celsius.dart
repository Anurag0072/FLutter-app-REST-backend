...
class celScreen extends StatefulWidget {
  celScreen({Key? key}) : super(key: key);

  @override
  _celScreenState createState() => _celScreenState();
}

class _celScreenState extends State<celScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Celsius Details',style: TextStyle(color: AppStyle.appBarColor)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('Charges: 2500',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ...
                    SizedBox(height: 20),
                    Container(
                      child:  Text('GST @18%: 450',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    Divider(
                      thickness: 5,
                    ),
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Total: 2950',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    // Divider(),
                    // SizedBox(height: 20),
                    // Container(
                    ...
                    Container(
                      alignment: Alignment.center,
                      padding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child:  Text('Capacity: 8',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                    ),
