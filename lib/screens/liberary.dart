  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Library Details',style: TextStyle(color: AppStyle.appBarColor)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('Tuesday - Saturday: 3PM - 11PM ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ...
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Sunday: 11AM - 11PM',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    Divider(
                      thickness: 5,
                    ),
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Monday Close',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    Divider(
                      thickness: 5,
                    ),
