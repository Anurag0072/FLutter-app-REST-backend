...
class unwindScreen extends StatefulWidget {
  unwindScreen({Key? key}) : super(key: key);

  @override
  _unwindScreenState createState() => _unwindScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Unwind Details',style: TextStyle(color: AppStyle.appBarColor)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      alignment: Alignment.center,
                      padding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child:  Text('Capacity: 25',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                    ),
