...
class commitiee extends StatefulWidget {
  commitiee({Key? key}) : super(key: key);

  @override
  _commitieeState createState() => _commitieeState();
}

class _commitieeState extends State<commitiee> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Managing Committee',style: TextStyle(color: AppStyle.appBarColor)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('Hon. President : Mr.Pankaj O. Chokhani ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ...
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Hon. Treasurer : Mr.Ashish R. Khemuka',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    Divider(
                      thickness: 5,
                    ),
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Committee Member : Mrs.Sneha A. Parikh',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    Divider(
                      thickness: 5,
                    ),
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Committee Member : Dr.Shivani S. Sule',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    Divider(
                      thickness: 5,
                    ),
                    SizedBox(height: 20),
                    Container(
                      child:  Text('Committee Member : Mr.Parth J. Majumdar',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
                    ),
                    // Divider(),
                    // SizedBox(height: 20),
                    // Container(
