...
class tennisScreen extends StatefulWidget {
  tennisScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Tennis Details',style: TextStyle(color: AppStyle.appBarColor)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('Morning 6AM - 9AM',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),
